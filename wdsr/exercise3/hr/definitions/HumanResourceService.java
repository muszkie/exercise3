 ...
 * 
 */
@WebServiceClient(name = "HumanResourceService", targetNamespace = "http://exercise3.wdsr/hr/definitions", wsdlLocation = "http://localhost:8090/holidayService/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HUMANRESOURCESERVICE_QNAME = new QName("http://exercise3.wdsr/hr/definitions", "HumanResourceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8090/holidayService/?wsdl");
    ...
    public HumanResource getHumanResourcePort() {
        return super.getPort(new QName("http://exercise3.wdsr/hr/definitions", "HumanResourcePort"), HumanResource.class);
    }
    ...
    public HumanResource getHumanResourcePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://exercise3.wdsr/hr/definitions", "HumanResourcePort"), HumanResource.class, features);
    }
